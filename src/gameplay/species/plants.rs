...
pub fn get_plant_tier_1() -> HashMap<&'static str, Species> {
    ...
    species.insert("Grass", 
        Species::new("Grass", Kingdom::Plant, 1, 8, Color::srgb(0.4, 0.7, 0.3))
            // Lifecycle system - Basic producer
            .with_feeding_requirement(MatterType::SoilNutrients, 1)
            .with_biomass_conversion(BiomassConversion::PlantGrowth { efficiency: 0.8 })
            .with_growth_age(5) // Takes 5 days to mature
            .with_reproduction_cooldown(7) // Can reproduce every 7 days
            .with_lifespan(60, 120) // Lives 60-120 days
    );
...
pub fn get_plant_tier_2() -> HashMap<&'static str, Species> {
    ...
    species.insert("Berry Bushes", 
        Species::new("Berry Bushes", Kingdom::Plant, 2, 6, Color::srgb(0.6, 0.3, 0.7))
    ...
    // Add Clover - key species for nitrogen fixing
